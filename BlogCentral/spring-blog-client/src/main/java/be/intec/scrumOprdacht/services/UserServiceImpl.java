...
import be.intec.scrumOprdacht.repositories.PasswordResetTokenRepository;
import be.intec.scrumOprdacht.repositories.UserRepository;
import be.intec.scrumOprdacht.repositories.VerificationTokenRepository;
...
public class UserServiceImpl implements IUserService {
    ...
    public User registerUser(UserModel userModel) {
        ...
        user.setPassCode(passwordEncoder.encode(userModel.getPassword()));
